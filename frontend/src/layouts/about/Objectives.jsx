        ...
        <div className="bg-whity rounded-3xl shadow-2xl p-4 sm:px-8">
            <div>
                <div className="flex justify-end px-8 md:px-16">
                    <h1 className="-mt-12 text-2xl text-secondary italic py-4 px-6 font-semibold bg-whity rounded-3xl shadow-2xl">OBJECTIVES</h1>
                </div>
                <div className="py-4 text-secondary text-justify">
                    <p className="text-sm md:text-base">
                        As a newly established platform, Open Career is committed to leveraging the latest technology and
                        ...
                        At Open Career, we prioritize inclusivity, diversity, and equal opportunities for all individuals,
                        ...
                        recommendations, and seamless application tracking, Open Career aims to empower both job seekers
