                            ...
                            <div className="max-w-xl mx-auto mb-12 border-t-4 xl:border-t-0 xl:border-l-4 even:border-gold odd:border-primary py-6 px-8 rounded-3xl shadow-2xl">
                                ...
                                <div className="py-4 flex flex-row justify-between items-center text-secondary">
                                    <div className="flex flex-row items-center text-sm space-x-4">
                                        ...
                                        <button onClick={handleWhatsAppShare} className="transition duration-200 transform hover:scale-150">
                                        ...
                                        <button onClick={handleFacebookShare} className="transition duration-200 transform hover:scale-150">
                                        ...
                                        <button onClick={handleTwitterShare} className="transition duration-200 transform hover:scale-150">
